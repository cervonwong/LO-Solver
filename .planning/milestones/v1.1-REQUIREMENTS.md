...
- [x] **DUCK-01**: Agent duck mascot icons are oversized, extending beyond the card boundary (top-left, absolute positioned)
- [x] **DUCK-02**: Duck mascots have a color tint that varies by agent type
...
| DUCK-01 | Phase 11 | Complete |
| DUCK-02 | Phase 11 | Complete |
