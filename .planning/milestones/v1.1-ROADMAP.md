...
- [x] **Phase 12: Workflow Control Buttons** - Abort/New Problem buttons, config disable, aborted state (completed 2026-03-03)
- [x] **Phase 13: 3-Column Layout** - Animated third column for vocabulary/rules with responsive collapse (completed 2026-03-03)
...
Plans:
- [x] 10-01-PLAN.md — LabeledList component and generic tool call formatting
- [x] 10-02-PLAN.md — Agent structured output on backend events and AgentCard section
...
Plans:
- [x] 11-01-PLAN.md — Agent role detection, duck mascot integration with tint and animations
