...
- [x] **KEY-01**: User can open an API key dialog from a button in the nav bar top-right
...
- [x] **KEY-04**: Button indicates key status (configured vs. needed)
...
- [x] **FLOW-05**: Solve request fails gracefully with clear error when no key is available from either source
